...
//create a new agent
router.post("/new-agent", authMiddleware_1.authMiddleware, (0, planMiddleware_1.requirePremium)(), rateLimiter_1.agentRateLimiter, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
